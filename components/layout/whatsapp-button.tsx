...
const WHATSAPP_NUMBER = "37258472379";
const WHATSAPP_MESSAGE = "Ciao! Ho una domanda sui kit di Esame Facile 👋";
    ...
    <div className="fixed bottom-44 right-4 z-50 flex flex-col items-end gap-2">
      ...
      {showTooltip && !dismissed && (
        <div className="flex items-start gap-2 bg-white rounded-2xl shadow-lg border border-neutral-200 px-4 py-3 max-w-[220px] animate-in slide-in-from-bottom-2 fade-in duration-300">
          <p className="text-body-sm text-neutral-700 font-medium leading-snug">
      ...
      <a
        ...
        className="w-14 h-14 rounded-full shadow-lg flex items-center justify-center hover:scale-110 active:scale-95 transition-transform"
